...
var AllProject = function () {
    ...
    return (React.createElement(Row, { xs: 1, sm: 2, lg: 3, className: "g-4 g-sm-5 g-md-4 g-lg-3 my-4" }, Array.from({ length: 4 }).map(function (_, idx) { return (React.createElement(Col, { key: idx },
